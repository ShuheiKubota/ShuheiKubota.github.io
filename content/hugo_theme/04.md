...
「このサイトのテーマとして、各レイアウト定義をどうしたか」を解説のとっかかりとして、レイアウト定義の内容を掲載しつつ、
...
現在注目している対象が切り替わっているため、`.` から始まる記述で取得できる情報の種類が変わってきたり、同じ情報を取得する記述でも取得できた値がもともとのコンテンツの値とは異なることがあったりします。
